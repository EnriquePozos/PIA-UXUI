<?php
// api/restar_carrito_controller.php
...
if ($stmt->execute()) {
    ...
    echo json_encode(array("message" => "Cantidad de producto reducida exitosamente"));
} else {
    http_response_code(500);
    echo json_encode(array("message" => "Error al restar producto del carrito: " . $stmt->error));
}
