<?php
// api/vaciar_carrito_controller.php
...
if (!isset($input['idUsuario']) || !is_numeric($input['idUsuario'])) {
    http_response_code(400);
    echo json_encode(array("message" => "idUsuario es requerido y debe ser numérico"));
    exit();
}
...
if ($stmt->execute()) {
    ...
    echo json_encode(array("message" => "Carrito vaciado exitosamente"));
} else {
    http_response_code(500);
    echo json_encode(array("message" => "Error al vaciar carrito: " . $stmt->error));
}
